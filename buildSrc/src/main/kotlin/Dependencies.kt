object Deps {
    ...
    object Androidx {
        ...
        const val lifecycleCommon = "androidx.lifecycle:lifecycle-common-java8:${Versions.androidLifecycle}"
        const val lifecycleRuntime = "androidx.lifecycle:lifecycle-runtime-ktx:${Versions.androidLifecycle}"
        const val lifecycleCompose = "androidx.lifecycle:lifecycle-viewmodel-compose:${Versions.androidLifecycle}"
    }
    ...
    object Test {
        ...
        const val composeUi = "androidx.compose.ui:ui-test-junit4:${Versions.composeLib}"
        const val composeTooling = "androidx.compose.ui:ui-tooling:${Versions.composeLib}"
        const val composeManifest = "androidx.compose.ui:ui-test-manifest:${Versions.composeLib}"
    }
}
